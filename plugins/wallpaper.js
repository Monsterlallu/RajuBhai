...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'wallpaper', fromMe: true, desc: 'random wallpaper images'}, (async (message, match) => {
...
var i = Math.floor(621*Math.random())
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '```MADE BY RAJU BHAI BOT 🖤```'})
    ...
    Asena.addCommand({pattern: 'wallpaper', fromMe: false, desc:'random wallpaper images '}, (async (message, match) => {
